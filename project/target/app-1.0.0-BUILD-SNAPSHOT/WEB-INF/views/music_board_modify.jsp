...
<head>
    ...
    <script src="/js/community_write_modify.js"></script>
...
<main id="main">
    <div class="contents_area">
        <h2 class="maintitle">음악소통 게시판 글수정</h2>
        <form action="/community/modify" method="post">
            <div class="music_board_wrap">
                ...
                <div class="music_board_row">
                    ...
                    <input type="text" class="c_music" name="c_music" value="${communityDto.c_music}" placeholder="최대 10자까지 이력이 가능합니다.">
                </div>

                <div class="music_board_row">
                    <div class="board_nav">제목</div>
                    <input type="text" class="c_title" name="c_title" value="${communityDto.c_title}" placeholder="최대 50자까지 입력이 가능합니다.">
                </div>
                <div class="music_board_content">
                    <div class="board_nav">내용</div>
                    <textarea name="c_content" id="c_content">${communityDto.c_content}</textarea>
                </div>
